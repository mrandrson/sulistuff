...
print("HDF5_USE_FILE_LOCKING =", os.getenv("HDF5_USE_FILE_LOCKING"))
import openmc
import openmc.model
...
op = openmc.deplete.CoupledOperator(model, chain_file = "/Users/richardanderson/openmc_data/chain_jeff33.xml")
timesteps = [(10, 'd')]*10
power = 250
